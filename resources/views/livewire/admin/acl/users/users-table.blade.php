<div>
    <div class="p-4 justify-between sm:inline-flex sm:space-x-2 space-x-0 sm:space-y-0 space-y-2">
        <div>
            <button wire:click="openCreateModal" class="w-full flex bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                        ...
                                        <div class="mt-2">
                                            <div class="grid grid-cols-2 space-x-2">
                                                <div class="mb-4">
                                                    ...
                                                    <input wire:model.defer="{{ !$viewMode || !$editMode ? 'name' : '' }}" type="text" name="name" id="name" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md {{ $viewMode ? 'cursor-not-allowed' : ' ' }}" @if($viewMode) disabled @endif>
                                                    @error('name') <span class="text-red-600">{{ $message }}</span> @enderror
                                                </div>
                                                <div class="mb-4">
                                                    <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Email</label>
                                                    <input wire:model.defer="{{ !$viewMode || !$editMode ? 'email' : '' }}" type="email" name="email" id="email" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md {{ $viewMode ? 'cursor-not-allowed' : ' ' }}" @if($viewMode) disabled @endif>
                                            ...
                                            @if (!$viewMode)
                                                <div class="grid grid-cols-2 space-x-2">
                                                    <div class="mb-4">
                                                        ...
                                                        <input wire:model.defer="password" type="password" name="password" id="password" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <input wire:model.defer="password_confirmation" type="password" name="password_confirmation" id="password_confirmation" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
